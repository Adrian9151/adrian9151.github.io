...
<head>
    ...
    <title>Diagramas Neumaticos CTS</title>
...
<main> 
  ...
  <div class="container__box">
        <a href="./cts/Diagramas Neumaticos/18078-N-701.pdf" target="visualizador">
            <div class="box">
            <img src="./img/Neumatico.png" width="120px" alt="">
             <h5>Diagrama <br> Neumatico</h5>
             <h4>Diagrama <br> Neumatico</h4>
            </div>
           
        <a href="./cts/Diagramas Neumaticos/18078-N-702.pdf" target="visualizador">
            <div class="box">
            <img src="./img/Neumatico.png" width="120px" alt="">
            <h5>Diagrama <br> Neumatico</h5>
            <h4>Diagrama <br> Neumatico</h4>
        ...
        <a href="./cts/Diagramas Neumaticos/18078-N-703.pdf" target="visualizador">
            <div class="box">
            <img src="./img/Neumatico.png" width="120px" alt="">
            <h5>Diagrama <br> Neumatico</h5>
            <h4>Diagrama <br> Neumatico</h4>
        ...
        <a href="./cts/Diagramas Neumaticos/18078-N-704.pdf" target="visualizador">
            <div class="box">
            <img src="./img/Neumatico.png" width="120px" alt="">
            <h5>Diagrama <br> Neumatico</h5>
            <h4>Diagrama <br> Neumatico</h4>
