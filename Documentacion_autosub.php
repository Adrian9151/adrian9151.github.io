...
<head>
    ...
    <title>Documentacion Autosub</title>
...
<main> 
   ...
   <!-- <a href="./Kst_autosub.php"></a>
    ...
    <a href="./mantenimiento_preventivo_autosub.php"> <div class="box">
    ...
    <!--<div class="box">
        <a href="./Documentacion.html"><i class="lni lni-exit"></i></a>
        <h5>Salida</h5>
        <h4>Salida</h4>
    </div> -->
   </div>      
