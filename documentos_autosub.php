...
<main> 
  ...
  <br>
  <br>
    <!--<a href="./Documentacion_autosub.html"> 
        <div class="regresar">
             <h5>⏎ Regresar</h5>
         </div>
    </a>-->
  ...
  <div class="container__box">
    ...
    <div class="box">
        ...
        <div class="box">
         ...
         <br> <br>
         <a href="autosub/Diagramas Neumaticos/18079-N-701.pdf" target="visualizador">
            <div class="box">
            <i class="bx bx-wind"></i>
             <h5>18079-N-701</h5>
             <h4>18079-N-701</h4>
         </div></a>
         <a href="autosub/Diagramas Neumaticos/18079-N-702.pdf" target="visualizador">
            <div class="box">
                <i class="bx bx-wind"></i>
                 <h5>18079-N-702</h5>
                 <h4>18079-N-702</h4>
         </div></a>
         <a href="autosub/Diagramas Neumaticos/18079-N-703.pdf" target="visualizador">
            <div class="box">
                 <i class="bx bx-wind"></i>
                 <h5>18079-N-703</h5>
                 <h4>18079-N-703</h4>
         </div></a>
            <a href="autosub/Diagramas Neumaticos/18079-N-704.pdf" target="visualizador">
                <div class="box">
             <i class="bx bx-wind"></i>
                 <h5>18079-N-704</h5>
                 <h4>18079-N-704</h4>
         </div></a>
         <a href="autosub/Diagramas Neumaticos/18079-N-705.pdf" target="visualizador">
            <div class="box">
             <i class="bx bx-wind"></i>
                 <h5>18079-N-705</h5>
                 <h4>18079-N-705</h4>
         </div></a>
         <a href="autosub/Diagramas Neumaticos/18079-N-706.pdf" target="visualizador">
            <div class="box">
            <i class="bx bx-wind"></i>
                 <h5>18079-N-706</h5>
                 <h4>18079-N-706</h4>
         </div></a>
            <a href="autosub/Manuales/ib0600366engg.pdf" target="visualizador">
                <div class="box">
