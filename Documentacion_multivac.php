...
<head>
    ...
    <title>Documentacion Multivac</title>
...
<main> 
   ...
   <!-- <a href="./Kst_autosub.php"></a>
    ...
    <a href="./mantenimiento_preventivo_multivac.php"> <div class="box">
